...
public class ContactsRepositoryImpl implements ContactsRepository {
    ...
    public boolean init(){
        ...
        builder.remoteCache("contacts-ispn")
                .configuration("<infinispan><cache-container><distributed-cache mode=\"SYNC\" name=\"contacts-ispn\" owners=\"2\" statistics=\"true\"><encoding media-type=\"application/x-protostream\"/><persistence><file-store/></persistence></distributed-cache></cache-container></infinispan>");
