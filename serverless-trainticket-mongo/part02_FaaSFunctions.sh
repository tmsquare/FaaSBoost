...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ get-left-ticket-of-interval.yml
...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ get-left-trip-tickets.yml
...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ get-price-by-routeid-and-traintype.yml
...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ get-route-by-routeid.yml
...
cd getRouteByTripId/
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ get-route-by-tripid.yml
...
cd getSoldTickets/
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ get-sold-tickets.yml
...
cd getToken/
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ get-token.yml
...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ get-traintype-by-traintypeid.yml
...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ get-traintype-by-tripid.yml
...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ query-already-sold-orders.yml
...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ query-config-entity-by-config-name.yml
...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ query-for-station-id-by-station-name.yml
...
cd queryForTravel/
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ query-for-travel.yml
...
cd checkSecurity/
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ check-security.yml
...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ check-security-about-order.yml
...
cd createOrder/
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ create-order.yml
...
cd dipatchSeat/
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ dipatch-seat.yml
...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ find-contacts-by-accountid.yml
...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ get-contacts-by-contactsid.yml
...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ get-trip-all-detai-info.yml
...
cd preserveTicket/
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ preserve-ticket.yml
...
cd calculateRefund/
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ calculate-refund.yml
...
cd cancelTicket/
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ cancel-ticket.yml
...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ create-third-party-payment-and-pay.yml
...
cd drawBack/
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ drawback.yml
...
cd getOrderById/
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ get-order-by-id.yml
...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ get-stationid-list-by-name-list.yml
...
cd modifyOrder/
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ modify-order.yml
...
cd payForTheOrder/
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ pay-for-the-order.yml
...
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ query-orders-for-refresh.yml
...
cd saveOrderInfo/
sed -i'.original' -e s/192.168.49.2/$MASTER_ID/ save-order-info.yml
